...
We also experiment with a different layer structure from Figure~\ref{fig:bdc-circuit}, where we use $R_xR_zR_x$ rotation gates instead of $R_xR_yR_z$.
...
\begin{table}[ht]
	...
	\begin{minipage}{.45\textwidth}
		...
		\begin{tabular}{ c|c|c } 
			...
			\hline
			\multirow{3}{5em}{SGD ($\eta = 0.4$)} & 4 & 47.5\% \\ 
			& 8 & 0\% \\ 
			& 10 & 0\% \\
			& 12 & 0\% \\
			\hline
			\multirow{3}{5em}{RMSprop ($\eta = 0.01$)} & 4 & 57.6\% \\ 
			& 8 & 0\% \\ 
			& 10 & 0\% \\
			& 12 & 0\% \\
			\hline
			\multirow{3}{5em}{Adam ($\eta = 0.02$)} & 4 & 63.2\% \\ 
			& 8 & 0\% \\ 
			& 10 & 0\% \\
			& 12 & 0\% \\
			\hline
