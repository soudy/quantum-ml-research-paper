...
To circumvent this requirement, variational quantum machine learning algorithms have become a main focus area of research.
Variational quantum machine learning algorithms have shown the ability to perform machine learning tasks on NISQ devices while providing a means to deal with high dimensional data, which has been unpractical on classical computers~(\cite{mitarai2018quantum}).
...
We use the original $28 \times 28$ MNIST data set to train a QNN to detect if a handwritten digit is 0 or not 0.
