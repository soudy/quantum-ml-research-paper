...
\begin{equation}
\bra{\varphi} = \ket{\varphi}^\dagger = \begin{pmatrix}c_0^* & c_1^*\end{pmatrix}.
\end{equation}
...
\begin{equation}
\lvert \ip{0}{\psi} \rvert^2 = \left\lvert \dfrac{i}{2} \right\rvert^2 = \dfrac{1}{4},
\end{equation}
...
\begin{table}[ht]
	...
	\begin{minipage}{.45\textwidth}
		...
		\begin{tabular}{ c|c|c } 
			...
			\hline
			\multirow{3}{5em}{SGD ($\eta = 0.05$)} & 4 & 25.3\% \\ 
			& 8 & 26.3\% \\ 
			& 10 & 41.4\% \\
			& 12 & 0\% \\
			\hline
			\multirow{3}{5em}{RMSprop ($\eta = 0.01$)} & 4 & 47.7\% \\ 
			& 8 & 69.2\% \\ 
			& 10 & 67.4\% \\
			& 12 & 0\% \\
			\hline
			\multirow{3}{5em}{Adam ($\eta = 0.02$)} & 4 & 54.9\% \\ 
			& 8 & 62.4\% \\ 
			& 10 & 73.2\% \\
			& 12 & 0\% \\
			\hline
